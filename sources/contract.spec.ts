...
describe("contract", () => {
    ...
    beforeAll(async () => {
        ...
        token = blockchain.openContract(await SampleJetton.fromInit(deployer.address, content));
    ...
    it("Onchian Testing: DeDust", async () => {
        ...
        const jettonRoot = blkch.openContract(await SampleJetton.fromInit(player.address, content));
